...
(defun jl/resize-inline ()
  (if (derived-mode-p 'org-mode)
      (progn
        (setq org-image-actual-width (round (* (window-pixel-width) 0.5)))
        (org-redisplay-inline-images))))
(add-hook 'after-save-hook #'jl/resize-inline)
(add-hook 'org-mode-hook #'jl/resize-inline)
#+end_src
*** Org Toc
#+begin_src emacs-lisp
(use-package toc-org
...
(use-package corfu
  ...
  :config
    ...
    (set-face-attribute 'corfu-default nil :background "#11111B")
    (set-face-attribute 'corfu-current nil :background "#2a2e38")
    (set-face-attribute 'corfu-popupinfo nil :background "#181825")
    (set-face-attribute 'corfu-border nil :background "#cba6f7")
    (set-face-attribute 'corfu-bar nil :background "#89b4fa")
