...
(use-package dirvish
  ...
  :config
   (setq dirvish-header-line-format
    ...
    (set-face-attribute 'dirvish-hl-line nil :background "#89b4fa")
...
(use-package ement
  ...
  :general
    (leader 
      "m m" '((lambda () (interactive) (persp-switch "matrix") (ement-connect :uri-prefix "http://localhost:8008" )) :wk "Matrix with ement"))
