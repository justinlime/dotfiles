...
(use-package general
  ...
  (leader
    ...
    "r c" '(org-capture-finalize :wk "Toggle the roam buffer")
...
(setq treesit-language-source-alist
  '((nix "https://github.com/nix-community/tree-sitter-nix")
    ...
    (typescript "https://github.com/tree-sitter/tree-sitter-typescript/tree/master/typescript") ; not working, their directory structure is whack
