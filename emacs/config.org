...
(add-hook 'dired-mode-hook #'(lambda () 
  ...
  (face-remap-add-relative 'default `(:height ,(+ jl/font-size 20)))
  (dired-omit-mode)
  (auto-revert-mode)
...
(use-package diredfl 
  ...
  :config
    (set-face-attribute 'diredfl-dir-heading nil :height (+ jl/font-size 40) :foreground "#cba6f7"))
#+end_src
*** Dired Filter
#+begin_src emacs-lisp
...
(add-hook 'org-mode-hook #'(lambda ()
  (face-remap-add-relative 'default `(:height ,(+ jl/font-size 10)))
  (org-indent-mode)
  (display-line-numbers-mode -1)
...
(use-package dashboard
  :hook (dashboard-mode . (lambda () (face-remap-add-relative 'default `(:height ,(+ jl/font-size 20)))))
  :config
