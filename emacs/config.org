...
(add-hook 'term-mode-hook #'(lambda()
  ;; Id bruh
  ;; (face-remap-add-relative 'default :background "#11111B")
  ;; (face-remap-add-relative 'term-bold '((:background "#11111B") term-bold))
  ;; (face-remap-add-relative 'term '((:background "#11111B") term-bold))
  (buffer-face-mode 1)
  ;; (custom-set-faces   '(default ((t (:background "#11111B"))))) 
  ;; (face-remap-add-relative 'default :background "#11111B")
  ;; (add-text-properties (point-min) (point-max) '(font-lock-face (:background "#11111B")))
  (display-line-numbers-mode -1)
))
#+end_src 
*** Modes
