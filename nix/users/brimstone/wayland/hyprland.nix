...
# See https://wiki.hyprland.org/Configuring/Monitors/
    ...
    exec-once=hyprctl setcursor ${custom.cursor} ${custom.fontsize}
    exec-once=swaync
...
# For all categories, see https://wiki.hyprland.org/Configuring/Variables/
    ...
    general {
        ...
        col.active_border = rgb(${custom.accent})
        col.inactive_border = rgb(${custom.background})
    ...
    decoration {
        ...
        col.shadow = rgb(${custom.accent})
        col.shadow_inactive = rgb(${custom.background})         
    }
