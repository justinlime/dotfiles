...
#+begin_src emacs-lisp
(use-package gptel
    :hook (gptel-mode . (lambda () (visual-line-mode)))
    :config
      (setq gptel-backend
      ...
      (setq gptel-model "QuantTrio/Qwen3-VL-30B-A3B-Instruct-AWQ")
      (setq gptel--system-message 
        "You are a LLM that lives in Emacs. Respond conciesly. 
         Use ORG for all formatting instead of markdown. If code blocks are used,
         ensure the appropriate language is used in the '#begin_src' tag.")
