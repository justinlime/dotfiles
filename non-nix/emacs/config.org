...
(use-package toggle-term
  ...
  :general
    (leader
      "t t" '(toggle-term-toggle-bottom :wk "Toggle the active toggle-term")
      "t f" '(toggle-term-find :wk "Find a toggle-term, or create a new one")
      "t r" '(toggle-term-toggle-right :wk "Toggle the rightmost active toggle-term"))
  :hook (toggle-term-spawn . (lambda () (evil-insert 1)))
  :config
    (setq toggle-term-size 25)
    (setq toggle-term-init-toggle '("ghostel" . "ghostel"))
    (setq toggle-term-types '(ghostel term shell eshell ielm))
