...
(use-package ghostel
  ...
  :ensure t
  :config 
    (set-face-attribute 'ghostel-default nil :background "#11111B")
...
(use-package toggle-term
  ...
  :config
    ...
    (setq toggle-term-init-toggle '("ghostel" . "ghostel"))
...
(defun jl/ssh (host formatter)
  ...
  (let ((format-host (format formatter host host)))
    ...
    (toggle-term-find "ghostel" "ghostel")
